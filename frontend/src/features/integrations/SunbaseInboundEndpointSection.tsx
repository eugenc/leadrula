...
export function SunbaseInboundEndpointSection({
  ...
  return (
    <div className="space-y-3 rounded-lg border border-green-200 bg-green-50 p-4">
      <div>
        <p className="text-sm font-semibold text-green-900">Integration connected</p>
      ...
      <div className="flex items-center gap-1.5 rounded-md border border-white bg-white px-3 py-2 font-mono text-xs text-gray-800">
