...
function blankBranch(position: number, accountType: "publisher" | "buyer"): RouteBranch {
  return {
...
function reindexBranches(branches: RouteBranch[]): RouteBranch[] {
...
export { blankBranch, reindexBranches };
